...
$recuringEvents[] = new event(new DateTime("2021-08-02T19:00:00+02:00", $timezone), "Trap in 1 hour! <@&" . PLAYER . ">", 172800, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-02T19:30:00+02:00", $timezone), "Trap in 30 minutes! <@&" . PLAYER . ">", 172800, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-02T19:55:00+02:00", $timezone), "Trap in 5 minutes! <@&" . PLAYER . ">", 172800, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-02T20:00:00+02:00", $timezone), "Trap now! <@&" . PLAYER . ">", 172800, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-05T19:00:00+02:00", $timezone), "Horde in 1 hour! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-05T19:30:00+02:00", $timezone), "Horde in 30 minutes! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-05T19:55:00+02:00", $timezone), "Horde in 5 minutes! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-05T20:00:00+02:00", $timezone), "Horde now! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-03T19:00:00+02:00", $timezone), "Horde in 1 hour! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-03T19:30:00+02:00", $timezone), "Horde in 30 minutes! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-03T19:55:00+02:00", $timezone), "Horde in 5 minutes! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
$recuringEvents[] = new event(new DateTime("2021-08-03T20:00:00+02:00", $timezone), "Horde now! <@&" . PLAYER . ">", 1209600, CHANNEL_ID);
...
$discord->on(DiscordEvent::MESSAGE_CREATE, function (Message $message, Discord $discord) {
    try {
        ...
        if ($id != BOT_ID && !$isCommand && array_key_exists($message->channel_id, $autotranslateChannels)) {
